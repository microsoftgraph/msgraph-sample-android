...
Add the following members to the `CalendarFragment` class.
...
Add the following line of code in the `success` override after the `mEventList = iEventCollectionPage.getCurrentPage();` line.
